...
from info import AUTH_CHANNEL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORTLINK_URL, SHORTLINK_API, LOG_CHANNEL, GRP_LNK, CHNL_LNK, CUSTOM_FILE_CAPTION, IS_VERIFY, VERIFY2_URL, VERIFY2_API, PROTECT_CONTENT, HOW_TO_VERIFY, PREMIUM_LOGS
...
async def send_all(bot, userid, files, ident):
    ...
    if not await db.has_premium_access(userid) and not await check_verification(bot, userid):
        btn = [[
            ...
            InlineKeyboardButton("⚡ ᴜɴʟᴏᴄᴋ ᴘʀᴇᴍɪᴜᴍ ⚡", callback_data="check")
          ]]
        await bot.send_message(
            chat_id=userid,
            text="<b>Yᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ!\nKɪɴᴅʟʏ ᴠᴇʀɪғʏ ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ Sᴏ ᴛʜᴀᴛ ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ᴀᴄᴄᴇss ᴛᴏ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇs ᴜɴᴛɪʟ 48 ʜᴏᴜʀs ғʀᴏᴍ ɴᴏᴡ !</b>",
