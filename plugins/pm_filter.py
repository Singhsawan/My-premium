            ...
            InlineKeyboardButton("⛥ ʀᴇᴍᴏᴠᴇ ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ ⛥", url="https://t.me/TheHappyHourBOT?start=TheHappyHour")
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                [
                                [
                                InlineKeyboardButton("🎁 ᴏɴʟɪɴᴇ ꜱᴛʀᴇᴇᴍ + ᴅᴏᴡɴʟᴏᴀᴅ 🎁", callback_data=f"stream#{file_id}")
                            ],[
                    ...
                    if await db.has_premium_access(query.from_user.id):
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                [
                                [
                                InlineKeyboardButton("𒊹 ᴏɴʟɪɴᴇ ꜱᴛʀᴇᴇᴍ / ᴅᴏᴡɴʟᴏᴀᴅ 𒊹", callback_data=f"stream#{file_id}")
                            ],[
                            InlineKeyboardButton('✺ ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ✺', url='http://t.me/TheHappyHourBot?startgroup=start')
                            ]
                                ]
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            search = message.text
            m=await message.reply_sticker(sticker="CAACAgUAAxkBAAEXAnNlpgghbiOtOK3Pmm7majdRIIRY7gACRwADJpleD38508ect3TIHgQ",
